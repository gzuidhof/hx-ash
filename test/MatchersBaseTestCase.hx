...
//Adaptation for ordinary haxe.unit testing. Now extends haxe.unit.TestCase.
...
/**
	...
	```
**/
class MatchersBaseTestCase extends TestCase
{
  ...
  //  {
	...
	**/
	public function assertThat<T>(actual:Dynamic, ?matcher:Matcher<T>, ?reason:String, ?info:PosInfos)
	{
		...
		assertTrue(true); //Necessary for TestCase..
	}
	...
	**/
	public function isA<T>(type:Class<Dynamic>):Matcher<T>
	{
		return Is.isA(type);
	}
	...
	**/
	public  function theInstance<T>(target:T):Matcher<T>
	{
	...
	**/
	public  function startsWith(prefix:String):Matcher<String>
	{
	...
	**/
	public  function endsWith(suffix:String):Matcher<String>
	{
	...
	**/
	public  function containsInOrder<T>(first:Dynamic,
	                            ?second:Dynamic,
	                            ?third:Dynamic,
	                            ?fourth:Dynamic,
	                            ?fifth:Dynamic,
	...
	**/
	public  function hasSize<T>(value:Dynamic):Matcher<Iterable<T>>
	{
	...
	/**
		...
		`assertThat([], isEmpty())`.
	**/
	public  function isEmpty<E>():Matcher<Iterable<E>>
	{
		return IsEmptyIterable.isEmpty();
	}
	...
	**/
	public  function hasEntry<K, V>(key:Dynamic, value:Dynamic):Matcher<Map<K, V>>
	{
	...
	**/
	public  function hasKey<K, V>(key:Dynamic):Matcher<Map<K, V>>
	{
	...
	**/
	public  function hasValue<K, V>(value:Dynamic):Matcher<Map<K, V>>
	{
